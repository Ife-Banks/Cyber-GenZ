...
const navigate = () => {
    return (
        <div className='absolute text-white flex items-center justify-between w-full px-5 md:max-lg:pl-10 lg:pl-30 md:max-lg:pr-10 lg:pr-20  lg:gap-x-20 bg-[#131718] font-redHat z-2 p-1 ' >
            <div className=' w-fit'>
               <a href="">
