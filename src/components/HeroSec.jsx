    ...
    return ( 
        <div className='flex flex-col overflow-hidden relative items-center'>
            ...
            <div className='z-1 absolute top-[20%]  lg:top-[22%] md:max-lg::top-[30%] text-white w-[100%] sm:max-lg:w-[90%] lg:w-[63%] flex flex-col gap-y-5 items-center '>
                <h1 className='font-bold text-3xl/12 sm:max-md:text-4xl/15 md:text-5xl/18 text-center p-2 font-redHat relative'>Empowering the Next <span className=" relative after:absolute after:text-xs after:rounded-xl after:py-1 after:lg:py-2 after:w-35 after:h-7 after:place-self-center after:content-center after:text-white after:inset-x-0 after:left-10 after:lg:left-40 after:-top-[40%] after:sm:max-lg:-top-[25%] after:lg:-top-[25%] after:rounded-bl-none after:content-['Penetration\00a0Testing']  after:bg-[linear-gradient(180deg,_#4343F1_0%,_#00F_100%)] after:bg-[linear-gradient(180deg,_color(display-p3_0.2611_0.2611_0.9083)_0%,_color(display-p3_0_0_1)_100%)] after:-z-1"> Generation</span> of <span className="relative before:absolute  before:content-['Cyber\00a0SecurityAnalyst'] before:text-xs   before:w-35 before:h-7   before:border before:right-35 before:top-2 before:place-content-center before:rounded-xl before:rounded-br-none before:text-black before:bg-[#FF0] before:bg-[color(display-p3_1_1_0)] before:inline"> Cyber</span> Defenders to Protect, Innovate, and Lead in a <span className=" relative after:absolute after:text-xs after:rounded-xl after:w-35 after:h-7 after:place-self-center after:text-white after:inset-x-0 after:left-10 after:lg:left-110 after:-top-[40%] after:sm:max-lg:-top-[25%] after:lg:top-[0%] after:rounded-br-none after:content-['Network\00a0Security']  after:bg-[#F00] after:bg-[color(display-p3_1_0_0)]after:bg-[linear-gradient(180deg,_color(display-p3_0.2611_0.2611_0.9083)_0%,_color(display-p3_0_0_1)_100%)] after:font-medium after:-z-1 after:place-content-center after:border after:border-[rgba(255,255,255,0.40)]">Secure</span> Digital World.</h1>
                <p className='text-xs w-fit text-center text-[#6B7275] text-[color(display-p3_0.424_0.4469_0.4583)] font-inter after:'>Shaping Tomorrow’s Cybersecurity Leaders with Cutting-Edge Skills and Unwavering Commitment.
                </p>
