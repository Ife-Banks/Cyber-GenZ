        ...
        <div className='flex flex-col overflow-hidden relative items-center'>
            ...
            <div className='z-1 absolute top-[20%]  lg:top-[22%] md:max-lg::top-[30%] text-white w-[100%] sm:max-lg:w-[90%] lg:w-[90%] flex flex-col gap-y-5 items-center'>
                ...
                <div className='flex gap-x-3 lg:gap-x-6 justify-center'>
                    ...
                    <div className='flex items-center justify-center rounded-3xl  border border-[#FEFEFE] sm:max-md:px-1  h-10 w-40 lg:w-40'>
                        <a href="" className=' sm:max-md:text-xs md:text-sm text-[#FEFEFE] font-semibold flex justify-center'>
                            Watch a demo
                        </a>
                    </div>
