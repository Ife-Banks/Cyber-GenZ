...
const Hero = () => {
    return ( 
        <div className='flex flex-col overflow-hidden relative items-center'>
            ...
            <Navigate/>
            {/* HEroText */}
            <div className='z-1 absolute top-[20%]  lg:top-[25%] md:max-lg::top-[30%] text-white w-[100%] sm:max-lg:w-[90%] lg:w-[75%] font-bold  text-3xl/12 sm:max-md:text-4xl/15 md:text-5xl/16 text-center p-2 font-redHat text-shadow-sm text-shadow-white'>
